...
def action(msg):
    ...
    ''' start of you code '''
    if 'humid' in command:
        message = "The current humidity is {}%.".format(humidity)
        telegram_bot.sendMessage(chat_id, message)
    elif 'temp' in command:
        message = "The current temperature is {}°C.".format(temp)
        telegram_bot.sendMessage(chat_id, message)
...
''' start of you code '''
telegram_bot = telepot.Bot('7656436979:AAGsAkkPmTU5vJCEYybXZiD21p9xi_pb-ko')
''' end of you code '''
